...
export default function AppProvider({children}) {
  ...
  console.log(error)
    ...
    return (
        <AppContext.Provider value={{sharedTask, setSharedTask, updateTask, deleteTask, deleteProject, updateProject, sharedProject, setSharedProject,createTask, showTaskForm, setShowTaskForm, getUserInfo, user, setUser, createProject, searchTerm, setSearchTerm, showProjectForm, setShowProjectForm, error, setError}}>
            {loading && <Loader/>}
            {children}
        </AppContext.Provider>
    )
